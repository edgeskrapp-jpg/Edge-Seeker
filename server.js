...
app.get("/api/picks/premium", (req, res) => {
  res.status(501).json({
    error: "Premium picks temporarily unavailable",
    message: "Premium access is coming soon. Check back shortly.",
  });
});
...
app.get("/api/agent/premium", (req, res) => {
  res.status(501).json({
    error: "Premium agent temporarily unavailable",
    message: "Premium access is coming soon. Check back shortly.",
  });
});

app.get("/api/agent/game-analysis", (req, res) => {
  res.status(501).json({
    error: "Game analysis temporarily unavailable",
